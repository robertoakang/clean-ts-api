import { ISaveSurveyResultRepository, ILoadSurveyResultRepository, SurveyResultModel, ISaveSurveyResult, SaveSurveyResultParams } from './db-save-survey-result-protocols'
