...
describe('SaveSurveyResult Controller', () => {
  ...
  test('Should call ILoadAnswersBySurvey with correct value', async () => {
  ...
  test('Should return 403 if ILoadAnswersBySurvey returns null', async () => {
    const { sut, loadAnswersBySurveySpy } = makeSut()
  ...
  test('Should return 500 if ILoadAnswersBySurvey throws', async () => {
    const { sut, loadAnswersBySurveySpy } = makeSut()
